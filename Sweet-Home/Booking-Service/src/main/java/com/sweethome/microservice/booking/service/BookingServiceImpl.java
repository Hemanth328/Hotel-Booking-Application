...
import com.sweethome.microservice.booking.DAO.BookingInfoEntityDAO;
...
public class BookingServiceImpl implements BookingService{
    ...
    * method 1 roomPrize--> Get the room price based on number of rooms
    ...
    * */
    ...
    @Override
    public BookingInfoEntity makeTransaction(TransactionDetailsEntityDTO transactionDetailsEntityDto, int id) throws InvalidPaymentMethodException,
            BookingIdNotFoundException {

        if(!(transactionDetailsEntityDto.getPaymentMode().equalsIgnoreCase("CARD")  || transactionDetailsEntityDto.
                getPaymentMode().equalsIgnoreCase("UPI"))){
